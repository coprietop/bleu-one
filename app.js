...
// ===== Bleu One v1.9 · Gimnasio 4 en 14 =====
(()=>{
  ...
  function renderObjection(){const item=pick(objections);optionGame('Laboratorio de objeciones','Objeción · '+item.cat,item,'objections',renderObjection)}
  ...
  function renderSpeech(){const item=pick(speeches);optionGame('Completa el speech','Laboratorio del speech experto',item,'instant',renderSpeech)}
